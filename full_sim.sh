...
## Run DELLY
./bwa/bwa mem -R '@RG\tID:alt\tSM:alt' hpv_16.fa alt1.fq alt2.fq | samtools view -bSh - > alt.tmp.bam && \
sambamba sort -o alt.bam alt.tmp.bam && \
./delly/src/delly call -t DEL -g hpv_16.fa alt.bam -o alt.del.sv.delly.bcf && \
./delly/src/delly call -t INS -g hpv_16.fa alt.bam -o alt.ins.sv.delly.bcf && \
./delly/src/delly call -v recall.alt.vcf -g hpv_16.fa alt.bam -o alt.regenotype.delly.bcf && \
./delly/src/delly call -v recall.alt.vcf -g hpv_16.fa alt.bam -o alt.regenotype.delly.bcf && \
...
## Run LUMPY
./extract.sh alt.bam && \
sambamba view -h --num-filter /1294 alt.bam | samtools sort -@ 2 -o alt.discords.bam - && \
./lumpy-sv/bin/lumpyexpress -B alt.bam -D alt.discords.bam -S alt.splitters.bam -o alt.lumpy.vcf && \
./svtyper/svtyper -i alt.lumpy.vcf -B alt.bam -o alt.svtyper.vcf && \
cat alt.svtyper.vcf
